...
//byte bits defines
#define IIC_byte_1bits 1
#define IIC_byte_2bits 2
#define IIC_byte_3bits 3
#define IIC_byte_4bits 4
#define IIC_byte_5bits 5
#define IIC_byte_6bits 6
#define IIC_byte_7bits 7
#define IIC_byte_8bits 0
//--------------------------------------------
// Structures
//--------------------------------------------
